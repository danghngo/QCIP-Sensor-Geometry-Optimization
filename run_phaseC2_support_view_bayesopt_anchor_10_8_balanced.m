function run_phaseC2_support_view_bayesopt_anchor_10_8_balanced()
% run_phaseC2_support_view_bayesopt_anchor_10_8_balanced
%
% Phase C.2 corrective support-view Bayesian optimization.
% Fixed first-view anchor = balanced near-10% error case
%   az = 10 deg, el = 8 deg, baseline = 0.20, HFOV = 18 deg, range = 20 m
%   reproduced H/L/W/Mean = 5.2143 / 7.4564 / 16.8801 / 9.8503
...
fprintf('\n============================================================\n');
fprintf('Phase C.2 support-view BO driver (balanced corrective anchor 10/8)\n');
...
function cfg = local_default_config()
    ...
    cfg.first_view.azimuth_deg = 10;
    cfg.first_view.elevation_deg = 8;
    cfg.first_view.baseline = 0.20;
    cfg.first_view.hfov_deg = 18;
    cfg.first_view.range = 20;
    ...
    cfg.output_root = fullfile(cfg.this_dir, 'outputs', ['phaseC2_support_view_BO_anchor_10_8_balanced_' cfg.timestamp]);
